...
def serve_scoreboard():
    ...
    return send_from_directory('.', 'padel_scoreboard_clean_winner.html')
...
if __name__ == '__main__':
    print("🏓 Starting Enhanced Padel Scoreboard with Match Storage...")
    print("=" * 90)
    ...
    print("📊 NEW: Enhanced Match Storage System")
    print("🏆 Detailed winner data with comprehensive statistics")
    ...
    print("  GET  /health             - System status with storage info")
    print("=" * 90)
    print("✨ NEW FEATURES:")
    print("  • Comprehensive match statistics storage")
    print("  • Detailed sets breakdown for winner display")
    print("  • Points/games/sets tracking per team")
    print("  • Match duration calculation")
    print("  • Automatic data wipe after display")
    print("  • Enhanced winner announcements")
    print("=" * 90)
    print("🚀 Starting enhanced server with match storage...")
    print("")
